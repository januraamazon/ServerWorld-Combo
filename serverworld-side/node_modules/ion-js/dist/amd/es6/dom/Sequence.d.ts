...
export declare function Sequence(ionType: IonType): {
    ...
    from<T_3, U_3>(arrayLike: ArrayLike<T_3>, mapfn: (v: T_3, k: number) => U_3, thisArg?: any): U_3[];
    from<T_4>(iterable: Iterable<T_4> | ArrayLike<T_4>): T_4[];
    from<T_5, U_4>(iterable: Iterable<T_5> | ArrayLike<T_5>, mapfn: (v: T_5, k: number) => U_4, thisArg?: any): U_4[];
