...
define(["require", "exports", "jsbi", "../Ion", "./Value", "./FromJsConstructor"], function (require, exports, jsbi_1, Ion_1, Value_1, FromJsConstructor_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    jsbi_1 = __importDefault(jsbi_1);
    let _jsbiConstructor = jsbi_1.default;
    ...
    class Integer extends Value_1.Value(Number, Ion_1.IonTypes.INT, _fromJsConstructor) {
        constructor(value, annotations = []) {
            if (typeof value === "number") {
                ...
                let numberValue = jsbi_1.default.toNumber(value);
                super(numberValue);
