define(["require", "exports", "./Value", "./FromJsConstructor"], function (require, exports, Value_1, FromJsConstructor_1) {
    "use strict";
    ...
    function Sequence(ionType) {
        return class extends Value_1.Value(Array, ionType, FromJsConstructor_1.FromJsConstructor.NONE) {
            ...
            get(...pathElements) {
                ...
                let children = this;
                let maybeChild = children[pathHead];
                let child = maybeChild === undefined ? null : maybeChild;
            ...
            static _fromJsValue(jsValue, annotations) {
                ...
                let children = jsValue.map(child => Value_1.Value.from(child));
