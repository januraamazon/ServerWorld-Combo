...
define(["require", "exports", "./AbstractWriter", "./IonUnicode", "./IonTypes", "./IonLowLevelBinaryWriter", "./IonTimestamp", "./IonWriteable", "./util", "jsbi", "./JsbiSupport", "./JsbiSerde"], function (require, exports, AbstractWriter_1, IonUnicode_1, IonTypes_1, IonLowLevelBinaryWriter_1, IonTimestamp_1, IonWriteable_1, util_1, jsbi_1, JsbiSupport_1, JsbiSerde_1) {
    "use strict";
    ...
    class BinaryWriter extends AbstractWriter_1.AbstractWriter {
        ...
        writeDecimal(value) {
            ...
            let coefficientBytes = writeCoefficient ? JsbiSerde_1.JsbiSerde.toSignedIntBytes(coefficient, isNegative) : EMPTY_UINT8ARRAY;
