...
define(["require", "exports", "./IonDecimal", "./IonText", "./util"], function (require, exports, IonDecimal_1, IonText_1, util_1) {
    ...
    class Timestamp {
        constructor(localOffset, year, month = null, day = null, hour = null, minutes = null, seconds = null) {
        ...
        toString() {
            ...
            let o = this._localOffset;
            if (this._precision > TimestampPrecision.DAY) {
                if (o === 0 && util_1._sign(o) === 1) {
                    strVal = strVal + "Z";
                }
                else {
                    strVal += (util_1._sign(o) === -1 ? '-' : '+')
    ...
    class _TimestampParser {
        static _parse(str) {
            ...
            while (pos < limit) {
                if (state.len === null) {
                    let digits = _TimestampParser._readUnknownDigits(str, pos);
                    if (digits.length === 0)
    ...
    _TimestampParser._timeParserStates = {
        [_States.YEAR]: new _TimeParserState(_States.YEAR, 4, { "T": _States.OFFSET_UNKNOWN, "-": _States.MONTH }),
        [_States.MONTH]: new _TimeParserState(_States.MONTH, 2, { "T": _States.OFFSET_UNKNOWN, "-": _States.DAY }),
        [_States.DAY]: new _TimeParserState(_States.DAY, 2, { "T": _States.HOUR }),
        [_States.HOUR]: new _TimeParserState(_States.HOUR, 2, { ":": _States.MINUTE }),
