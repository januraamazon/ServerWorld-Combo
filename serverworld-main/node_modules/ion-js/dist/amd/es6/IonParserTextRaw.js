...
define(["require", "exports", "./IonText", "./IonText", "jsbi", "./IonTypes", "./JsbiSupport"], function (require, exports, IonText, IonText_1, jsbi_1, IonTypes_1, JsbiSupport_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    IonText = __importStar(IonText);
    ...
    class ParserTextRaw {
        constructor(source) {
            ...
            this._read_value_helper_minus = function (ch1, accept_operator_symbols, calling_op) {
                let op = undefined, ch2 = this._peek();
                if (ch2 == CH_i) {
                    ch2 = this._peek("inf");
