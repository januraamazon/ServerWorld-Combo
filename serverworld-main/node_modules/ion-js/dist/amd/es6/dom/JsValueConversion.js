...
define(["require", "exports", "../IonTypes", "../Ion", "jsbi", "../util"], function (require, exports, IonTypes_1, Ion_1, jsbi_1, util_1) {
    "use strict";
        ...
        switch (valueType) {
            ...
            case "number":
                return Number.isInteger(value)
                    ? IonTypes_1.IonTypes.INT
                    : IonTypes_1.IonTypes.FLOAT;
            case "boolean":
    ...
    function _ionValueFromJsValue(value, annotations = []) {
        ...
        let ionTypeConstructor = _domConstructorFor(ionType);
