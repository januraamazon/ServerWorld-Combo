 ...
 */
define(["require", "exports", "./AbstractWriter", "./IonUnicode", "./IonText", "./IonTypes", "./util", "./JsbiSupport"], function (require, exports, AbstractWriter_1, IonUnicode_1, IonText_1, IonTypes_1, util_1, JsbiSupport_1) {
    "use strict";
            ...
            this._serializeValue(IonTypes_1.IonTypes.CLOB, value, (value) => {
                ...
                for (let i = 0; i < value.length; i++) {
                    ...
                    if (c > 127 && c < 256) {
                        ...
                        let escape = IonText_1.ClobEscapes[c];
                        if (escape === undefined) {
                            if (c < 32) {
                                hexStr = "\\x" + c.toString(16);
                                for (let j = 0; j < hexStr.length; j++) {
