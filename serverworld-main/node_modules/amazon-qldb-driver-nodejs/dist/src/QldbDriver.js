...
class QldbDriver {
     ...
     */
    constructor(ledgerName, qldbClientOptions = {}, maxConcurrentTransactions = 0, retryConfig = DefaultRetryConfig_1.defaultRetryConfig) {
    ...
    executeLambda(transactionLambda, retryConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getSession = function (thisDriver, startNewSession) {
                return __awaiter(this, void 0, void 0, function* () {
                    LogUtil_1.debug(`Getting session. Current free session count: ${thisDriver._sessionPool.length}. ` +
                    ...
                    if (thisDriver._semaphore.tryAcquire()) {
                        ...
                        try {
                            ...
                            if (startNewSession || session == undefined) {
                                ...
                                session = new QldbSession_1.QldbSession(communicator);
                            }
                            return session;
                        }
                        catch (e) {
            ...
            const releaseSession = function (thisDriver, session) {
                if (session != null) {
                    thisDriver._semaphore.release();
                    thisDriver._availablePermits++;
                    if (session.isAlive()) {
            ...
            for (let retryAttempt = 1; true; retryAttempt++) {
                try {
                    session = null;
                    session = yield getSession(this, startNewSession);
                    ...
                    if (e instanceof Errors_1.ExecuteError) {
                        if (e.isRetryable) {
                            ...
                            if (retryAttempt == 1 && e.isInvalidSessionException) {
                                LogUtil_1.debug("Initial session received from pool is invalid. Retrying...");
                                continue;
                            }
                            ...
                            LogUtil_1.info(`A recoverable error has occurred. Attempting retry #${retryAttempt}.`);
                            LogUtil_1.debug(`Error cause: ${e.cause}`);
                            continue;
                        }
                        else {
                            throw e.cause;
    ...
    getTableNames() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.executeLambda((transactionExecutor) => __awaiter(this, void 0, void 0, function* () {
                ...
                const listOfTableNames = resultStructs.map(tableNameStruct => tableNameStruct.get("name").stringValue());
