    ...
    executeLambda(transactionLambda) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const isRetryable = Errors_1.isRetryableException(e);
                const isISE = Errors_1.isInvalidSessionException(e);
                if (isISE && !Errors_1.isTransactionExpiredException(e)) {
                    // Underlying session is dead on InvalidSessionException except for transaction expiry
                    this._isAlive = false;
                }
                else if (!Errors_1.isOccConflictException(e)) {
