...
class QldbHash {
    ...
    dot(that) {
        ...
        const newHashLib = crypto_1.createHash("sha256");
    ...
    static toQldbHash(value) {
        if (typeof value === "string") {
            const writer = ion_js_1.makeTextWriter();
            writer.writeString(value);
            writer.close();
            value = writer.getBytes();
        }
        const hashReader = ion_hash_js_1.makeHashReader(ion_js_1.makeReader(value), ion_hash_js_1.cryptoHasherProvider("sha256"));
        hashReader.next();
        hashReader.next();
